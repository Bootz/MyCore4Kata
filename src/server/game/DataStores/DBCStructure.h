...
struct SpellEntry
{
	...
	int32     EffectBasePoints[MAX_SPELL_EFFECTS];          // 80-82    m_effectBasePoints (must be used in spell/auras explicitly, must be used cached Spell::m_currentBasePoints)
